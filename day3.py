...
a1 = ["R75","D30","R83","U83","L12","D49","R71","U7","L72"]
a2 = ["U62","R66","U55","R34","D71","R55","D58","R83"]

b1 = ["R98","U47","R26","D63","R33","U87","L62","D20","R33","U53","R51"]
b2 = ["U98","R91","D20","R16","D67","R40","U7","R15","U6","R7"]
...
def runWire(wire, id):
    ...
    for part in wire:
        ...
        #print("x: " + str(x) + " y: " + str(y) + " part: " + part)
    ...
    for y in range(GRID_SIZE):
        for x in range(GRID_SIZE):
            ...
            if closest == None or dist < closest:
                closest = dist
    print("Biggest X : " + str(maxX) + " Y: " + str(maxY))
    return closest
...
def runWireB(wire):
    ...
    for part in wire:
        ...
        for step in range(count):
            ...
            dupeString = str(y) + "x" + str(x)
            if dupeString not in visited:
                visited[dupeString] = totalSteps

    print(visited)
    return visited

def taskB():
    visited1 = runWireB(wire1)
    visited2 = runWireB(wire2)

    shortest = None
    for k in visited1.keys():
        if k in visited2:
            print(k)
            sum = visited1[k] + visited2[k]
            if shortest == None or sum < shortest:
                shortest = sum
    print(shortest)
